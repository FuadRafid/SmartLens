 ...
 * (i.e., the com.example.fuadrafid.smartlens.camera preview).  The creator can add graphics objects, update the objects, and remove
 * them, triggering the appropriate drawing and invalidation within the view.<p>
 *
 * Supports scaling and mirroring of the graphics relative the com.example.fuadrafid.smartlens.camera's preview properties.  The
 * idea is that detection items are expressed in terms of a preview size, but need to be scaled up
 * to the full view size, and also mirrored in the case of the front-facing com.example.fuadrafid.smartlens.camera.<p>
 *
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    /**
     * Sets the com.example.fuadrafid.smartlens.camera attributes for size and facing direction, which informs how to transform
